...
from trajectory_diffusion.env.objnav.objnav_env import ObjNavEnv
from trajectory_diffusion.env.objnav.pymunk_keypoint_manager import PymunkKeypointManager
import numpy as np

class ObjNavKeypointsEnv(ObjNavEnv):
    def __init__(self,
            legacy=False,
            block_cog=None, 
            damping=None,
    ...
    def genenerate_keypoint_manager_params(cls):
        env = ObjNavEnv()
        kp_manager = PymunkKeypointManager.create_from_objnav_env(env)
