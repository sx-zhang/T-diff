from trajectory_diffusion.model.common.normalizer import SingleFieldLinearNormalizer
from trajectory_diffusion.common.pytorch_util import dict_apply, dict_apply_reduce, dict_apply_split
import numpy as np
