...
class DiffusionTransformerHybridImagePolicy(BaseImagePolicy):
    def __init__(self, 
        ...
        # obs_encoder = nn.Linear(in_features=117*514, out_features=132)
        self.obs_encoder = resnet_obs_encoder.resnet18(pretrained=True)
        ...
        # self.normalizer_c = LinearNormalizer()
        # self.normalizer_a = LinearNormalizer()
    ...
    def predict_action(self, obs_dict: Dict[str, torch.Tensor]) -> Dict[str, torch.Tensor]:
        ...
        # run sampling
        nsample, restore_for_pic = self.conditional_sample(
            cond_data, 
            cond_mask,
            cond=cond,
            **self.kwargs)
        ...
        result = {
            ...
            'n_restore_for_pic': restore_for_pic,
        }
        return result, restore_for_pic
